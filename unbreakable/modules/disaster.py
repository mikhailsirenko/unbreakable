...
def get_region_damage(all_damage: pd.DataFrame, region: str, return_per: int) -> tuple[float, float, float]:
    '''
    ...
    Args:
        ...
        return_per (int): The return period to filter the data.
